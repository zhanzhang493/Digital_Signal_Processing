...
def phase_estimation_module_2(s_i, s_q, ideal_phase_est):
    ...
    """ phase wrapping """
    relative_phase_error_est_unwrap_wrap = PhaseModule.PhaseModule.phase_wrapping(relative_phase_error_est_unwrap)

    return real_phase_est, phase_error_est, phase_error_est_unwrap, \
           relative_phase_error_est_unwrap, relative_phase_error_est_unwrap_wrap
...
if __name__ == '__main__':
    ...
    IDEAL_FREQ_ERROR_WRAP_UNWRAP = (IDEAL_RELATIVE_PHASE_ERROR_WRAP_UNWRAP[1:] - IDEAL_RELATIVE_PHASE_ERROR_WRAP_UNWRAP[0:-1]) / TS  # sub-Nyquist sampling
    ...
    RELATIVE_PHASE_ERROR_EST_UNWRAP, RELATIVE_PHASE_ERROR_EST_UNWRAP_WRAP \
        = phase_estimation_module_2(S_REAL_I, S_REAL_Q, IDEAL_PHASE_EST)
    ...
    ax_spec.set_title('Fig.3 - Frequency Response of Phase-Domain Filter',
                      fontsize = 25, fontproperties=font_times)
    ...
    # ax_spec.plot(T_AXIS / us, REAL_PHASE_UNWRAP, 'orange', linewidth=2, label='unwrapped real phase')
    ax_spec.plot(f_axis_shift / MHz, freq_response_dB, 'b', linewidth=2, label='LPF frequency response')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]

    PHASE_ERROR_EST_UNWRAP_FILTER = filter_LPF(PHASE_ERROR_EST_UNWRAP)

    ax_spec = fig_spec.add_subplot(num_row, num_col, 4)
    ax_spec.set_title('Fig.4 - Input and Output of Phase-Domain Filter',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS[:256] / us, PHASE_ERROR_EST_UNWRAP[:256], 'g', linewidth=2,
                 label='input - unwrapped estimated phase')
    ax_spec.plot(T_AXIS[:256] / us, PHASE_ERROR_EST_UNWRAP_FILTER[:256], 'r', linewidth=1, label='output')
    ...
    ax_spec.set_title('Fig.5 - Estimated Phase by Phase Estimator',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS[:256] / us, IDEAL_PHASE_EST[:256], 'kx-', linewidth=2, label='estimated ideal phase')
    ax_spec.plot(T_AXIS[:256] / us, REAL_PHASE_EST_2[:256], 'go--', linewidth=1, label='estimated real phase')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]
    ...
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, PHASE_ERROR_EST, 'g', label='estimated phase error')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]
    ...
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, PHASE_ERROR_EST_UNWRAP, 'g', linewidth=1,
    ...
    ax_spec.set_title('Fig.8 - Wrapping Relative Phase Error Estimation',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, IDEAL_RELATIVE_PHASE_ERROR_WRAP, 'k', linewidth=2,
                 label='relative phase error')
    ax_spec.plot(T_AXIS / us, RELATIVE_PHASE_ERROR_EST_UNWRAP_WRAP, 'g--', linewidth=1,
    ...
    ax_spec.set_title('Fig.9 - Estimated Phase by Phase Estimator',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS[:256] / us, IDEAL_PHASE_EST[:256], 'kx-', linewidth=2, label='estimated ideal phase')
    ax_spec.plot(T_AXIS[:256] / us, REAL_PHASE_EST_1[:256], 'ro--', linewidth=1, label='estimated real phase')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]
    ...
    ax_spec.set_title('Fig.10 - Phase Un-Wrapping',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, IDEAL_PHASE_UNWRAP, 'b', linewidth=5, label='unwrapped ideal phase')
    ax_spec.plot(T_AXIS / us, REAL_PHASE_EST_UNWRAP, 'r', linewidth=2, label='unwrapped estimated phase')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]
    ...
    ax_spec.set_title('Fig.11 - Phase De-Ramping',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, PHASE_ERROR_UNWRAP_EST, 'r', label='estimated unwrapped phase error')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
    [label.set_fontname('Times New Roman') for label in labels]
    ...
    ax_spec.set_title('Fig.12 - Wrapping Relative Phase Error Estimation',
                      fontsize = 25, fontproperties=font_times)
    ax_spec.set_xlabel('time - us', fontsize = 22, fontproperties=font_times)
    ax_spec.set_ylabel('Phase', fontsize = 22, fontproperties=font_times)
    ax_spec.plot(T_AXIS / us, IDEAL_RELATIVE_PHASE_ERROR_WRAP, 'k', linewidth=2,
                 label='relative phase error')
    ax_spec.plot(T_AXIS / us, RELATIVE_PHASE_ERROR_UNWRAP_EST_WRAP, 'r', linestyle='--', linewidth=1,
                 label='estimated relative phase error')
    plt.legend(fontsize = 22)
    plt.tick_params(labelsize=22)
    labels = ax_spec.get_xticklabels() + ax_spec.get_yticklabels()
